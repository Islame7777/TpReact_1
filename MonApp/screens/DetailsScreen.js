    ...
    return (
        <View style={styles.container}>
            ...
            <Button
                ...
                color="#F06292" // Rose Vif (pour un bouton d'action secondaire)
            />
        </View>
    );
}
...
const styles = StyleSheet.create({
    ...
    dataCard: {
        ...
        padding: 30,
        marginBottom: 40,
        backgroundColor: '#F8E9EB', // Rose Pâle
        borderRadius: 15,
        borderLeftWidth: 5,
        borderLeftColor: '#1E3A8A', // Bleu Foncé
    },
    label: {
        fontSize: 16,
    ...
    idValue: {
        fontSize: 42,
        fontWeight: '900',
        color: '#F06292', // Rose Vif pour l'emphase
        marginTop: 5,
    }
});
